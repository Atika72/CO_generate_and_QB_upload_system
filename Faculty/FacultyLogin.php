...
<body class="align">
  <div class="grid">
    ...
    <form action="./FacultyLoginTask.php" method="POST" class="form login">
      <div class="form__field">
        ...
        <input id="login__username" type="text" name="userid" class="form__input"
      ...
      <p>Not Registered Yet?<a class="link" href="./FacultyRegistration.php">Register Now</a></p>
